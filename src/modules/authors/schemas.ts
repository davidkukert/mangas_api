...
import { MangaAuthorPlain } from '@modules/mangas/schemas'
import { UserPlain } from '@modules/users/schemas'
...
export const AuthorRelations = t.Object(
	{
		mangas: t.Array(MangaAuthorPlain, { additionalProperties: false }),
		user: __nullable__(UserPlain),
	},
	{ additionalProperties: false },
)
